...
#import "BCVIInjuryHealed.h"

@implementation BCVIInjuryHealed
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Yes"]) {
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"discontinueAnthithrombotics"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"anthithrombotics6months"];
