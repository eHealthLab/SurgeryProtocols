...
#ifndef SurgeryProtocols_BATStable_h
#define SurgeryProtocols_BATStable_h
...
@interface BATStable: UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
