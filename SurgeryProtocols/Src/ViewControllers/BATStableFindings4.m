...
#import "BATStableFindings4.h"
#import "AppDelegate.h"

@implementation BATStableFindings4
{
...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects: @"Normal Mental Status", @"No Chest Findings", @"Hermaturia", @"None of these", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"None of these"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BATIsolatedHead"];
        ...
        delegate.BATStableFinalOutcome=@"Abdomen/Pelvis CT";
