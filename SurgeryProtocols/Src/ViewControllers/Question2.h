...
#ifndef SurgeryProtocols_Question2_h
#define SurgeryProtocols_Question2_h
...
@interface Question2: UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
