...
#import "BluntHepticBlush.h"
#import "AppDelegate.h"

@implementation BluntHepticBlush
{
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Positive"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BluntHepaticObservation"];
