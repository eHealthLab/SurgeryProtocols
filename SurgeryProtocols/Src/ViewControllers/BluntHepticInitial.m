...
#import "BluntHepticInitial.h"
#import "AppDelegate.h"

@implementation BluntHepticInitial
{
...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"Stable", @"Unstable", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Stable"]) {
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BLTHepticStable"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BLTHepticUnstable"];
