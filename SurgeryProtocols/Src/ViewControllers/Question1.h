...
#ifndef SurgeryProtocols_Question1_h
#define SurgeryProtocols_Question1_h
...
@interface Question1: UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
