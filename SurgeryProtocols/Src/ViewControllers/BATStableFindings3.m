...
#import "BATStableFindings3.h"
#import "AppDelegate.h"

@implementation BATStableFindings3
{
...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:  @"Chest Pain or Tenderness", @"Normal Mental Status", @"Normal C-Spine",  @"Abnormal CXR", @"None of these", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"None of these"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BATStableFindings4"];
        ...
        delegate.BATStableFinalOutcome=@"Chest/Abdominal CT ";
