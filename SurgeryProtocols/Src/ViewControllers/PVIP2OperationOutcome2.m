...
#import "PVIP2OperationOutcome2.h"
#import "AppDelegate.h"

@implementation PVIP2OperationOutcome2
{
...
-(void)viewDidLoad
{
    ...
    delegate.PVIP2OperatioOutcome=@"";
    
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"Orthopaedic fixation", @"Warm and stabilize patient in SICU", nil];
