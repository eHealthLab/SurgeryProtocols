...
#ifndef SurgeryProtocols_PVIP2Soft_h
#define SurgeryProtocols_PVIP2Soft_h
...
@interface PVIP1Soft: UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
