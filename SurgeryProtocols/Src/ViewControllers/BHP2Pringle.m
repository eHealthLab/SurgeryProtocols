...
#import "BHP2Pringle.h"
#import "AppDelegate.h"

@implementation BHP2Pringle
{
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Controlled Bleeding"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BHP2SelectiveVessel"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BHP2vascular"];
