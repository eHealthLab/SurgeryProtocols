...
#import "BLTHepticStable.h"
#import "AppDelegate.h"

@implementation BLTHepticStable
{
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Stable"]) {
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BluntHepticBlush"];
