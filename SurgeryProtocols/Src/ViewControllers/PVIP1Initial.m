...
#import "PVIP1Initial.h"
#import "AppDelegate.h"

@implementation PVIP1Initial
{
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Hard signs"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PVIP1Hard"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PVIP1Soft"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PVIP1Pulses"];
