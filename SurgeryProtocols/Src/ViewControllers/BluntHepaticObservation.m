...
#import "BluntHepaticObservation.h"
#import "AppDelegate.h"

@implementation BluntHepaticObservation
{
...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"SIRS Abdominal pain", @"Continued Transfusion requirement", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"SIRS Abdominal pain"]) {
