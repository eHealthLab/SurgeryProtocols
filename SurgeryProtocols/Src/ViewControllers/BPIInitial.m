...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"CT Abdomen", @"Exploratory Laparotomy", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"CT Abdomen"]) {
        
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BPICTAbdomen"];
