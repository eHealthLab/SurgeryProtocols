...
#import "BHP2SelectiveVessel.h"
#import "AppDelegate.h"

@implementation BHP2SelectiveVessel
{
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Controlled Bleeding"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BHP2SHAL"];
