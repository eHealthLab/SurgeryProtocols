...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"Yes", @"No", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"Yes"]) {
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BATStable"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BATUnstable"];
