...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"stopped at the first diagram", @"went beyond diagram but not entire protocol", @"went through every step", nil];
