...
-(void)viewDidLoad
{
    ...
    self.BluntHepaticArray = [[NSArray alloc] initWithObjects:@"API >=0.9", @"API < 0.9", nil];
...
- (IBAction)nextButtonPressed:(id)sender {
    ...
    if ([choice isEqualToString:@"API >=0.9"]) {
        
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PVIP1Discharge"];
        ...
        UIViewController *uiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PVIP1Imaging"];
