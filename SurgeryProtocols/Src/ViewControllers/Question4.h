...
#ifndef SurgeryProtocols_Question4_h
#define SurgeryProtocols_Question4_h
...
@interface Question4: UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
